...
const controls=document.createElement('div');controls.className='trail-controls';controls.innerHTML='<span>Possibilities</span><button type="button">Replay entrance</button><a href="../infinite-coded-v1/index.html">Saved version ↗</a>';document.body.append(controls);
